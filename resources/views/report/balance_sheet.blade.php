    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-body table-responsive with-border">
                ...
                <br>
                <!-- Memberikan jarak antara form filter dan tabel -->
                <div class="mb-8"></div> <!-- Tambahkan jarak -->

                <!-- Baris untuk tabel Aktiva dan Pasiva -->
                <div class="row">
                    <!-- Tabel Aktiva -->
                    <div class="col-md-6 mb-4">
                        <h4 class="font-weight-bold" style="font-size: 24px; text-align: center;">Aktiva</h4>
                        <table id="aktivaTable" class="table table-striped table-bordered table-hover" style="font-size: 16px;">
                            <thead>
                                <tr>
                                    <th><h6>Kode</h6></th>
                    ...
                    <!-- Tabel Pasiva -->
                    <div class="col-md-6 mb-4">
                        <h4 class="font-weight-bold" style="font-size: 24px; text-align: center;">Pasiva</h4>
                        <table id="pasivaTable" class="table table-striped table-bordered table-hover" style="font-size: 16px;">
                            <thead>
                                <tr>
                                    <th><h6>Kode</h6></th>
                                    <th><h6>Nama Akun</h6></th>
                ...
                <!-- Memberikan jarak antara tabel dan balance -->
                <div class="mb-5"></div> <!-- Tambahkan jarak -->

                <!-- Keseimbangan Aktiva dan Pasiva -->
                <table class="table table-striped table-bordered" style="font-size: 16px; color: green;">
                    <thead>
                        <tr>
                            <th colspan="3" class="text-left">
                                <div>
                                    <span><strong>Balance: Rp.</strong></span>
